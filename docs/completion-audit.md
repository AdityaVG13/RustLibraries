...
- External ASV-derived comparison: NumRust wins 89 of 90 supported cases, NumPy wins 1 linalg near tie, 10.84x geomean speedup, 7 near-ties within 2%, ranked higher by wins on supported external cases.
