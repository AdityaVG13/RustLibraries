...
- External ASV-derived comparison: NumRust wins 61 of 62 supported cases, NumPy wins 1, 8.06x geomean speedup, 5 near-ties within 2%, ranked higher by wins on supported external cases.
