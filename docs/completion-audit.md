...
- External ASV-derived comparison: NumRust wins 51 of 53 supported cases, NumPy wins 2, 8.87x geomean speedup, 5 near-ties within 2%, ranked higher by wins on supported external cases.
