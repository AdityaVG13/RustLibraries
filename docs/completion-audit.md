...
- External ASV-derived comparison: NumRust wins 78 of 80 supported cases, NumPy wins 2 linalg near ties, 8.79x geomean speedup, 5 near-ties within 2%, ranked higher by wins on supported external cases.
