...
- External ASV-derived comparison: NumRust wins 113 of 114 supported cases, NumPy wins 1 copied-transpose linalg near tie, 28.63x geomean speedup, 6 near-ties within 2%, ranked higher by wins on supported external cases.
