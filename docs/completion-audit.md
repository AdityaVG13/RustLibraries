...
- External ASV-derived comparison: NumRust wins 82 of 84 supported cases, NumPy wins 2 linalg near ties, 8.41x geomean speedup, 7 near-ties within 2%, ranked higher by wins on supported external cases.
