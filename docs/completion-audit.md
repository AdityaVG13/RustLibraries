...
- External ASV-derived comparison: NumRust wins 71 of 72 supported cases, NumPy wins 1, 9.07x geomean speedup, 6 near-ties within 2%, ranked higher by wins on supported external cases.
