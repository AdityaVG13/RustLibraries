...
- External ASV-derived comparison: NumRust wins 57 of 58 supported cases, NumPy wins 1, 8.63x geomean speedup, 3 near-ties within 2%, ranked higher by wins on supported external cases.
