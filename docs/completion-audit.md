...
- External ASV-derived comparison: NumRust wins 108 of 108 supported cases, NumPy wins 0, 22.07x geomean speedup, 6 near-ties within 2%, ranked higher by wins on supported external cases.
