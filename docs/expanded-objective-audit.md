...
| Benchmark ranking | Targeted same-data suite: NumRust wins 10 of 10 vs NumPy 2.4.4, 1.67x geomean speedup. Externally derived NumPy ASV suite: NumRust wins 95 of 96 supported cases, NumPy wins 1 linalg near tie, 14.03x geomean speedup, 5 near-ties within 2%, and is ranked higher by wins on supported external cases. |
...
- External NumPy ASV-derived comparison: NumRust 95 wins, NumPy 1 win, 14.03x geomean speedup, 5 near-ties within 2%, ranked higher by wins on supported cases; 1 unsupported external case bucket tracked.
