...
| NumPy core | `numrs-core` | NumPy 2.4.4 | Pinned NumPy ASV-derived suite | 102 supported | 101 | 1 | No | 17.47x geomean | 0 | [`external-numpy-asv-inspired.md`](../benchmark-results/external-numpy-asv-inspired.md) |
| NumPy loss triage | `numrs-core` | NumPy 2.4.4 | Focused rerun of current NumPy wins | 1 | 0 | 1 | No | linalg near-tie remains | 0 | [`external-numpy-loss-focused.md`](../benchmark-results/external-numpy-loss-focused.md) |
...
The authoritative full report currently has 1 NumPy-winning supported row, a linalg near tie. The focused-loss artifact reruns that row with 3 alternating passes and still leaves it as a NumPy near-tie winner. The full report remains authoritative, and the global NumPy replacement claim stays false because the supported external slice is not the full NumPy API surface.
