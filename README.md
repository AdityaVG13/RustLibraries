...
- [ ] 2026-05-07: Optimize current full external NumPy near-tie losses without hiding rows: `asv_linalg_dot_trans_a_atc_f64_150x400_400x150` and `asv_linalg_matmul_trans_atc_a_f64_400x150_150x400`. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
