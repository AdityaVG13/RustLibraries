...
- [x] 2026-05-07: Add NumRust `flip`, `moveaxis`, and `roll`, plus pinned NumPy ASV manipulation rows for those operations. Latest external ASV evidence: 65 NumRust wins, 2 NumPy wins, 8.47x geomean, 0 checksum failures. Evidence: `crates/numrs-core/src/array.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
...
- [ ] 2026-05-07: Optimize the current full external NumPy linalg losses without hiding rows: `asv_linalg_matmul_trans_a_at_f64_150x400_400x150` and `asv_linalg_matmul_trans_atc_a_f64_400x150_150x400`. Latest focused rerun flips both to NumRust, but the full 67-case report remains authoritative. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
