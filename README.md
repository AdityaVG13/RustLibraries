...
| NumPy core, external ASV-derived | `numrs-core` | NumPy 2.4.4 | 53 | 51 | 2 | No | 8.87x geomean | [`external-numpy-asv-inspired.md`](benchmark-results/external-numpy-asv-inspired.md) |
| NumPy current-loss focused rerun | `numrs-core` | NumPy 2.4.4 | 2 | 1 | 1 | No | 1.07x win / 0.99x near-tie loss | [`external-numpy-loss-focused.md`](benchmark-results/external-numpy-loss-focused.md) |
...
- [ ] 2026-05-07: Optimize current full external NumPy near-tie losses without hiding rows: `asv_linalg_dot_trans_a_atc_f64_150x400_400x150` and `asv_linalg_matmul_trans_atc_a_f64_400x150_150x400`. Latest focused rerun flips the dot row to NumRust and leaves copied-transpose matmul as a NumPy near-tie. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
