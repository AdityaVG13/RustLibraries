...
| NumPy core, external ASV-derived | `numrs-core` | NumPy 2.4.4 | 102 | 101 | 1 | No | 17.47x geomean | [`external-numpy-asv-inspired.md`](benchmark-results/external-numpy-asv-inspired.md) |
| NumPy current-loss focused rerun | `numrs-core` | NumPy 2.4.4 | 1 | 0 | 1 | No | linalg near-tie remains | [`external-numpy-loss-focused.md`](benchmark-results/external-numpy-loss-focused.md) |
...
- [x] 2026-05-07: Add NumRust `uint64` all-axis `mean`, `var`, and `std` support plus pinned NumPy ASV `StatsReductions(dtype=uint64)` rows for min, max, mean, std, prod, and var. Latest external ASV evidence: 101 NumRust wins, 1 NumPy win, 17.47x geomean, 0 checksum failures; focused-loss evidence leaves the current NumPy-winning row as a NumPy near-tie. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
...
- [ ] 2026-05-07: Stabilize current full external NumPy linalg near ties without hiding rows. Latest full report has 1 NumPy-winning linalg near tie and 7 near-tie rows; the focused 3-pass rerun still leaves the current NumPy-winning row as a NumPy near-tie. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
