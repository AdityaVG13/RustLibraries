...
| NumPy core, external ASV-derived | `numrs-core` | NumPy 2.4.4 | 62 | 61 | 1 | No | 8.06x geomean | [`external-numpy-asv-inspired.md`](benchmark-results/external-numpy-asv-inspired.md) |
| NumPy current-loss focused rerun | `numrs-core` | NumPy 2.4.4 | 1 | 0 | 1 | No | 0.996x near-tie loss | [`external-numpy-loss-focused.md`](benchmark-results/external-numpy-loss-focused.md) |
