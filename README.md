...
| NumPy current-loss focused rerun | `numrs-core` | NumPy 2.4.4 | 2 | 2 | 0 | No | 1.02x | [`external-numpy-loss-focused.md`](benchmark-results/external-numpy-loss-focused.md) |
