...
- [ ] 2026-05-07: Stabilize current full external NumPy linalg near ties without hiding rows. Latest full report has 0 NumPy-winning supported rows and 6 linalg near-tie rows; keep stabilizing near ties without hiding rows. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
