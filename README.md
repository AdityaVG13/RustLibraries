...
- [ ] 2026-05-07: Stabilize current full external NumPy linalg near ties without hiding rows. Latest full report has 1 NumPy-winning linalg near tie and 7 near-tie rows; the focused 3-pass rerun flips the current NumPy-winning row to NumRust, but full-report wins remain the target. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
