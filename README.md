...
| NumPy core, external ASV-derived | `numrs-core` | NumPy 2.4.4 | 118 | 117 | 1 | No | 32.62x geomean | [`external-numpy-asv-inspired.md`](benchmark-results/external-numpy-asv-inspired.md) |
| NumPy current-loss focused rerun | `numrs-core` | NumPy 2.4.4 | 1 | 1 | 0 | No | current linalg loss flips to Rust | [`external-numpy-loss-focused.md`](benchmark-results/external-numpy-loss-focused.md) |
...
- [x] 2026-05-07: Add pinned NumPy ASV `float32` and `int32` `ConcatenateStackArrays` axis-0 owned-output rows for `concatenate` and `stack`. Step evidence: 78 NumRust wins, 2 NumPy wins, 8.79x geomean, 0 checksum failures; focused-loss evidence leaves 1 of 2 rows as a NumPy near-tie. Evidence: `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add pinned NumPy ASV `float32` and `int32` `ConcatenateStackArrays` axis-1 owned-output rows for `concatenate` and `stack`. Step evidence: 82 NumRust wins, 2 NumPy wins, 8.41x geomean, 0 checksum failures; focused-loss evidence flips both current NumPy-winning rows to NumRust. Evidence: `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add NumRust `float32` all-axis `mean`, `var`, and `std` support plus pinned NumPy ASV `StatsReductions(dtype=float32)` rows for min, max, mean, std, prod, and var. Step evidence: 89 NumRust wins, 1 NumPy win, 10.84x geomean, 0 checksum failures; focused-loss evidence flips the current NumPy-winning row to NumRust. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add NumRust `int64` all-axis `mean`, `var`, and `std` support plus pinned NumPy ASV `StatsReductions(dtype=int64)` rows for min, max, mean, std, prod, and var. Step evidence: 95 NumRust wins, 1 NumPy win, 14.03x geomean, 0 checksum failures; focused-loss evidence flips the current NumPy-winning row to NumRust. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add NumRust `uint64` all-axis `mean`, `var`, and `std` support plus pinned NumPy ASV `StatsReductions(dtype=uint64)` rows for min, max, mean, std, prod, and var. Step evidence: 101 NumRust wins, 1 NumPy win, 17.47x geomean, 0 checksum failures; focused-loss evidence leaves the current NumPy-winning row as a NumPy near-tie. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add NumRust `bool` all-axis `mean`, `var`, `std`, and `prod` support plus pinned NumPy ASV `StatsReductions(dtype=bool_)` rows for min, max, mean, std, prod, and var. Step evidence: 108 NumRust wins, 0 NumPy wins, 22.07x geomean, 0 checksum failures; focused-loss evidence has 0 current loss rows. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add NumRust `complex64` all-axis `min`, `max`, `mean`, `var`, and `std` support plus a fast uniform complex product path and pinned NumPy ASV `StatsReductions(dtype=complex64)` rows for min, max, mean, std, prod, and var. Step evidence: 113 NumRust wins, 1 NumPy win, 28.63x geomean, 0 checksum failures; focused-loss evidence flips the current NumPy-winning row to NumRust. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
- [x] 2026-05-07: Add NumRust NaN-aware `float32`/`float64` `fmin_all` and `fmax_all` support plus pinned NumPy ASV `FMinMax` rows for `np.fmin.reduce` and `np.fmax.reduce`. Latest external evidence: 117 NumRust wins, 1 NumPy win, 32.62x geomean, 0 checksum failures; focused-loss evidence flips the current NumPy-winning row to NumRust. Evidence: `crates/numrs-core/src/ops.rs`, `benchmarks/external_numpy_cases.py`, `benchmark-results/external-numpy-asv-inspired.md`, `benchmark-results/external-numpy-loss-focused.md`.
...
- [ ] 2026-05-07: Stabilize current full external NumPy linalg near ties without hiding rows. Latest full report has 1 NumPy-winning linalg near tie and 5 near-tie rows; the focused 3-pass rerun flips the current NumPy-winning row to NumRust. Target: `crates/numrs-core/src/blas.rs`, `benchmark-results/external-numpy-asv-inspired.md`.
