...
```sh
python -m pytest <repo>/target/external/array-api-tests/array_api_tests/test_data_type_functions.py::test_broadcast_arrays -q --tb=short --json-report --json-report-file=<repo>/target/array-api-tests-report.json --maxfail=5
```
